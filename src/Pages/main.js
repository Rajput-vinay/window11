...
import appsData from "../components/data/data";
    ...
    <>
      ...
      <div className="relative h-screen" ref={constraintsRef}>
        <div className="relative h-full w-full top-0 left-0 z-10 text-white">
          ...
          <div className="grid h-[80vh] grid-rows-6 gap-2 absolute top-2 left-2">
            {appsData.map((app, index) => (
              ...
              >
                <div
                  className="w-[5em] h-full flex flex-col justify-center items-center rounded-md hover:bg-white hover:bg-opacity-20 p-2 mt-6 "
